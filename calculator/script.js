class Calculator {
  ...
  compute() {
    ...
    this.currentOperand = Number(computation.toFixed(6));
    this.operation = undefined;
    this.previousOperand = '';
  }
  plusminus() {
  ...
  updateDisplay() {
    this.currentOperandTextElement.innerText =
     ...
     if (this.currentOperand != null && this.operation == '√'){
      this.previousOperandTextElement.innerText = `${this.previousOperand} ${this.operation}`;
      if (this.previousOperand > 0) {
        this.currentOperandTextElement.innerText = Math.sqrt(this.previousOperand);
        this.operation = undefined;
        this.currentOperand = '';
